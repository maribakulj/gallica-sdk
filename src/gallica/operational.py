...
_SEMANTICS: dict[str, OperationalSemantics] = {
    ...
    "document_toc": {"source_media_type": "text/html or application/xml", "output_semantics": "TocDocument preserving the upstream representation as legacy HTML or TEI XML without forcing them into a lossy common table model.", "errors": ("Empty payloads, malformed non-HTML XML or unexpected XML roots raise GallicaResponseError.",)},
