...
EVIDENCE: tuple[EvidenceSpec, ...] = (
    ...
    {"id": "live.document_access", "kind": "live-test", "status": "passing-in-ci", "target": "tests/test_live.py::test_public_gallica_phase1_document_access", "description": "Public smoke validation for document/page text, ContentSearch and dated Issues resolution.", **_LAST_LIVE_OBSERVATION},
    {"id": "live.corpus_document", "kind": "live-test", "status": "passing-in-ci", "target": "tests/test_live.py::test_public_gallica_corpus_v1", "description": "Public corpus validation for metadata/text artifacts, resume and manifest stability.", **_LAST_LIVE_OBSERVATION},
