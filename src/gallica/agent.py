...
CAPABILITIES: tuple[CapabilitySpec, ...] = (
    ...
    {"id": "page_iiif_info", "call": "Page.iiif_info", "description": "Retrieve typed IIIF Image API info.json metadata for one view.", "returns": "IIIFImageInfo", "network_service": "IIIF Image info.json", "parameters": (), "constraints": ("Image API is distinct from IIIF Presentation", "the SDK detects Image API version from advertised contexts/profiles", "positive width and height are required", "raw JSON remains available as raw_json")},
