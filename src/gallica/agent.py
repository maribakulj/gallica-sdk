...
CAPABILITIES: tuple[CapabilitySpec, ...] = (
    ...
    {"id": "document_iiif_manifest", "call": "Document.iiif_manifest", "description": "Retrieve the IIIF Presentation manifest with explicit protocol-version detection.", "returns": "IIIFPresentationManifest", "network_service": "IIIF Presentation", "parameters": (), "constraints": ("the SDK detects IIIF Presentation version explicitly", "BnF documentation currently advertises Presentation v2", "the SDK does not normalize v2 manifests into v3", "raw JSON remains available as raw_json")},
    ...
    {"id": "page_alto", "call": "Page.alto", "description": "Retrieve raw ALTO XML bytes for one view.", "returns": "bytes", "network_service": "RequestDigitalElement E=ALTO", "parameters": (), "constraints": ("view numbers are 1-based", "ALTO requests use the throttled alto rate bucket")},
    ...
    {"id": "page_image", "call": "Page.image", "description": "Retrieve one IIIF image with a conservative default width.", "returns": "bytes", "network_service": "IIIF Image", "parameters": ({"name": "width", "type": "int", "required": False, "default": 1000}, {"name": "fmt", "type": "str", "required": False, "default": "jpg"}), "constraints": ("width must be >= 1", "widths up to 1000 use the throttled iiif rate bucket", "width > 1000 uses the HD rate bucket", "1000px is the recommended default")},
